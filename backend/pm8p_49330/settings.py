"""
Django settings for pm8p_49330 project.
...
WSGI_APPLICATION = 'pm8p_49330.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "PM8p Support <support@pm8p-49330.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "pm8p_49330 API",
    "DESCRIPTION": "API documentation for pm8p_49330 App",
    "VERSION": "v1",
}
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = "pm8p_49330.storage_backends.AzureMediaStorage"
    STATICFILES_STORAGE = "pm8p_49330.storage_backends.AzureStaticStorage"
